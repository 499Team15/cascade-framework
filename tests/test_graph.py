from cascadef.graph import InfectionNode, Graph
from cascadef.model import SIModel
from cascadef.cascade import InfectionEvent
import pandas as pd

def test_create_node():
    node = InfectionNode(1, 'content', SIModel.SUSCEPTIBLE)
...
def test_graph():
    graph = Graph()
    node_1 = InfectionNode(1, 6, SIModel.SUSCEPTIBLE)
    node_2 = InfectionNode(2, 3, SIModel.SUSCEPTIBLE)
